    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api YuuXD - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6289689075040">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>YuuXD</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"YuuXD" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api YuuXD`,
        html: inboxGmail,
      };
